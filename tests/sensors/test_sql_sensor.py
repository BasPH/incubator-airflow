...
class SqlSensorTests(unittest.TestCase):
    ...
    @unittest.skipUnless('mysql' in conf.get('core', 'sql_alchemy_conn'), "this is a mysql test")
    ...
    @unittest.skipUnless('postgresql' in conf.get('core', 'sql_alchemy_conn'), "this is a postgres test")
